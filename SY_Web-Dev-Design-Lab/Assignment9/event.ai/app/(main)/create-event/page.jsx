...
export default function CreateEventPage() {
    ...
    const colorPresets = [
        ...
        ...(hasPro ? ["#30135cff", "#065f46", "#92400e", "#7f1d1d", "#831843"] : []),
    ];


    // const colorPresets = [
    //     "#3c3c3cff", // Default color (always available)
    //     ...(hasPro ? ["#292929ff", // Blue (default)
    //         "#7C5CFF", // Purple
    //         "#22C55E", // Green
    //         "#F59E0B", // Amber
    //         "#F43F5E", // Rose
    ...
    // ];
    // const colorPresets = [
    //     "#3c3c3cff", // Default Slate Gray
    //     ...(hasPro ? [
    //         "#475569ff", // Blue Slate (Cold, industrial blue)
    //         "#58508dff", // Deep Indigo (Muted, dusky purple)
    //         "#334155ff", // Charcoal Blue (Very dark, subtle accent)
    //         "#1e3a8aff", // Navy Night (Deep ocean blue)
    //         "#3f6212ff", // Forest Shadow (Dark, organic green)
    //         "#7c2d12ff", // Burnt Umber (Deep, earthy clay)
    //     ] : []),
    // ];
    ...
    //     "#3c3c3cff", 
    //     ...(hasPro ? [
    //         "linear-gradient(135deg, #1e3a8aff, #334155ff)", // Midnight Mix
    //         "linear-gradient(135deg, #3f6212ff, #262626ff)", // Forest Mix
    //         "linear-gradient(135deg, #58508dff, #7c2d12ff)", // Ember Mix
    //         "#475569ff", 
    //         "#58508dff",
    //         "#7c2d12ff"
    //     ] : []),
