          ...
          <div className="text-center sm:text-left">
            <div className="mb-6">
              <span className="text-gray-500 font-light tracking-wide">
                event.ai<span className="text-purple-400">*</span>
              </span>
            </div>
            ...
            <p className="text-lg sm:text-xl text-gray-400 mb-12 max-w-lg font-light">
              Whether you&apos;re hosting or attending, event.ai makes every event
            ...
            <Link href="/explore">
              <Button
                className="rounded-full px-12 py-7 text-xl font-semibold"
              >
                Get Started
              </Button>
            </Link>
